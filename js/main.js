...
$('#nav').affix({
    ...
    document.getElementById('sendEmailButt').onclick = function(){
        console.log("send mail");
    //     $.ajax({
    //       type: “POST”,
    //       url: "https://mandrillapp.com/api/1.0/messages/send.json",
    //       data: {
    //         'key': 'cc76cbd7c2749bd884b03d264bc2f35f-us17',
    //         'message': {
    //           'from_email': 'shadmanmahdi264@gmail.com',
    //           'to': [
    //               {
    //                 'email': 'md.ahmed1@yorkmail.cuny.edu',
    //                 'name': 'asshole',
    //                 'type': 'hoga'
    //               }
    //             ],
